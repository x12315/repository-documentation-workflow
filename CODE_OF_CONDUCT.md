...
辱骂、骚扰或其他不可接受的行为可向仓库维护者报告，并可通过 GitHub 的 moderation/举报路径报告。所有投诉都将得到及时和公平的审查和调查。
...
本文件采用 Contributor Covenant 2.1 官方中文文本，来源：https://www.contributor-covenant.org/zh-cn/version/2/1/code_of_conduct/code_of_conduct.md 。该文本遵循 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)；原作者与归属信息见 Contributor Covenant。
